...
public class VAD {
	...
	public float getMaxInitialSilence() {
		return maxInitialSilence;
	}

	public void setMaxInitialSilence(float maxInitialSilence) {
		this.maxInitialSilence = maxInitialSilence;
	}

	public float getMaxSilenceAfterWord() {
		return maxSilenceAfterWord;
	}

	public void setMaxSilenceAfterWord(float maxSilenceAfterWord) {
		this.maxSilenceAfterWord = maxSilenceAfterWord;
	}

	public float getMaxSpeechTime() {
		return maxSpeechTime;
	}

	public void setMaxSpeechTime(float maxSpeechTime) {
	...
	public boolean catchAudio(File recordingFile) throws Exception {
		...
		analyze();
		System.out.println("Audio detected. Flushing..");
		wait4ProcessEnd();
	...
	public void saveBytes(File filename, byte[] data) {
		try {
			...
			e.printStackTrace();
			System.out.println("Error saving bytes");
		}
	}
